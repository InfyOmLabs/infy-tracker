                ...
                <div class="filter-container">
                    ...
                    <div class="mr-2" style="margin-top: 20px;">
                        <div class="btn-group" role="group">
                            <button id="timeEntriesActions" type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                More
                            </button>
                            <div class="dropdown-menu" aria-labelledby="timeEntriesActions" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 35px, 0px); top: 0px; left: 0px; will-change: transform;">
                                <a href="#" class="dropdown-item filter-container__btn" id="new_entry" data-toggle="modal"
                                   data-target="#timeEntryAddModal">New Time Entry</a>
                                <a href="javascript:void(0)" class="dropdown-item filter-container__btn" id="copyTodayEntry">Copy Today Activity</a>
                            </div>
                        </div>
                    </div>
                </div>
