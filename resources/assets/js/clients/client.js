...
$(document).on('click', '.delete-btn', function (event) {
    ...
    let alertMessage = '<div class="alert alert-warning swal__text-div">\n' +
        '<strong class="swal__bold">Are you sure want to delete this client?</strong><div class="swal__m-top">By deleting this client all its project, task and time entries will be deleted.</div></div>';
